...
function SubSource(props) {
  ...
  return (
    <React.Fragment>
      <div className="page-content cls-search-space ">
        <MetaTags>
                ...
                <CardBody>
                    ...
                    <Col style={{ flex: '1 2', display: 'flex', justifyContent: 'flex-end' }}>
                      {access.includes('post') ?
                        <CreateForm
                          ...
                          error={error}
                          metaData={metaData}
                          onSubmit={(data, setSubmitting, redirect) => dispatch(actions.createRecord(Object.assign({}, data, ), setSubmitting, redirect))}>
                          {(openModal) => (
                            <Button
                              onClick={openModal}
                              color="primary">
                  ...
                  <DataTable
                    ...
                    onChangeStatus={(data, setSubmitting, redirect) => {
                      if (data && data.sub_sourceId && data.sub_sourceId.length > 0) {
...
export default connect(mapStateToProps, mapDispatchToProps)(SubSource)